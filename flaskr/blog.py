...
def get_post(id, check_author=True):
    ...
    # Note: 404 means “Not Found”, and 403 means “Forbidden”. 
    # (401 means “Unauthorized”, but you redirect to the login page instead of returning that status.)

    return post

@bp.route('/<int:id>/update', methods=('GET', 'POST'))  # If you don’t specify int: and instead do <id>, it will be a string.
@login_required
def update(id):
    post = get_post(id)
